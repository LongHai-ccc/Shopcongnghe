<?php
    ...
    if($_SERVER["REQUEST_METHOD"]=="POST")
    {
        ...
        if(empty($error))
        {
            ...
            $update =$db->update("articles",$data,array("id"=>$id));
            if($update>0)
            {
                move_uploaded_file($file_tmp,$part.$file_name);
                $_SESSION['success']="Update articles successfully !";
                redirectAdmin("articles");
            }
            else{
                $_SESSION['error']="Update articles NOT successfully !";
                redirectAdmin("articles");
            }
    ...
    <div class="container-fluid">
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                <input type="text" class="form-control" id="inputEmail3" placeholder="Articles Name ..." name="a_name" value="<?php echo $Editarticles['a_name'] ?>">
            ...
            <div class="form-group row" >
                ...
                <div class="col-sm-8">
                    <input type="file" class="form-control" id="inputEmail3" placeholder="avatar" name="a_avatar">
                    <?php if(isset($error['a_avatar'])):?>
                        <p class="text-danger">  <?php echo $error['a_avatar'] ?> </p>
                    <?php endif ?>
                    <img style="margin: 10px;" src="<?php echo uploads()?>articles/<?php echo $Editarticles['a_avatar'] ?>" width="450px" height="240px">
                </div>
            </div>
            <div class="form-group row">
                <label for="inputEmail3" class="col-sm-2 col-form-label" style="text-align: right;"><b>Discription short</b></label>
                <div class="col-sm-8">
                    <textarea class="form-control" name="a_description" rows="4"><?php echo $Editarticles['a_description'] ?></textarea>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <textarea class="form-control" name="a_content" rows="5"><?php echo $Editarticles['a_content'] ?></textarea>
