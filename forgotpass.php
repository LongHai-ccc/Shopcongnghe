        ...
        <!-- ----------MAIN-------------- -->
            ...
            <form class="form-horizontal" role="form" style="margin-top:30px" action="" method="POST">
                <div class="form-group">
                    <div style="text-align: center; margin-top: 10px;margin-bottom: 10px;">Please enter your email or phone number to search for your account.</div>
                ...
                <button type="submit" class="btn btn-primary col-md-6 col-md-offset-3 ">Send Require to Email</button>
                <a href="login.php" class= "col-md-2 col-md-offset-5 " style="margin-top:10px;" id="forgot_pswd">Return-LOGIN</a>
            </form> <!-- /form -->
        <!-- ----------MAIN-------------- -->
    </section>
</div>
